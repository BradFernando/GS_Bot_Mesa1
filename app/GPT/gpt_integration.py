...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    menu_patterns = [
        ...
        r'\bver men[úu]\b',  # frases como "ver menú"
    ...
    most_sold_food_patterns = [
        ...
        r'\bcu[aá]l es la comida m[aá]s vendida\b',
        r'\bcu[aá]l es la comida m[aá]s popular\b',
        r'\bcu[aá]l es la comida m[aá]s pedida\b',
        r'\bcu[aá]l es el platillo m[aá]s vendido\b',
        r'\bcu[aá]l es el platillo m[aá]s popular\b'
        r'\bcu[aá]l es el plato m[aá]s vendido\b',
        r'\bcu[aá]l es el plato m[aá]s popular\b',
